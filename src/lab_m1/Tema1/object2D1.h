...
namespace object2D1
{
    ...
    Mesh* CreateDoubleTrapezoid2(const std::string& name, glm::vec3 center, float bottomLength1, float topLength1, float height1, glm::vec3 color1, float bottomLength2, float topLength2, float height2, glm::vec3 color2, float rotationAngle, float height3);
