...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 0.5, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0.5, 1, 0.9), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 0.4, 1), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0.5, 0.5), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0.1, 0.3, 0.7), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 0.6, 0.8), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 1, 0.2), glm::vec3(0.2, 0.8, 0.6)),
        };
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0, 0), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(-1, 0, -1), glm::vec3(1, 0, 0), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(1, 0, -1), glm::vec3(1, 0, 0), glm::vec3(0, 1, 0)),

            
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 0), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 0), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 1, 0), glm::vec3(0, 1, 0)),

           
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0, 1), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(1, 0, -1), glm::vec3(0, 0, 1), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 0, 1), glm::vec3(0, 1, 0)),

            VertexFormat(glm::vec3(-1, 0, -1), glm::vec3(1, 1, 0), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 1, 0), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(1, 0, -1), glm::vec3(1, 1, 0), glm::vec3(0, 1, 0)),
        };
...

    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(-1, 0,  0), glm::vec3(0.2, 0.1, 0.3), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0.7, 0.6, 0.8), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(1, 2,  0), glm::vec3(0.3, 0.5, 0.4), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(-1, 2,  0), glm::vec3(0.8, 0.1, 0.5), glm::vec3(1, 0, 0)),
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_A"], shaders["VertexColor"], glm::vec3(-2, 0.5f, -0.5f), glm::vec3(0.5f));
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0), glm::vec3(0.5f));
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(1.8f, 1.2f, -1.5f), glm::vec3(1.25f));
    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(1, 0, 0), glm::vec3(0.25f));
    //RenderMesh(meshes["cube_A"], shaders["VertexColor"], glm::vec3(-2, 0.5f, -0.5f), glm::vec3(0.5f));
   // RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0), glm::vec3(0.5f));
   // RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(1.8f, 1.2f, -1.5f), glm::vec3(1.25f));
   // RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(1, 0, 0), glm::vec3(0.25f));
